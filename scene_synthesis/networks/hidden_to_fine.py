...
class AutoregressiveDMLL(Hidden2Output):
    def __init__(
        ...
        n_classes,
        n_mixtures,  # 10
        bbox_output,  # class AutoregressiveBBoxOutput
        with_extra_fc = False
    ):
        ...
        c_hidden_size = c_hidden_size + 64  # 768+64=832
        ...
        self.bbox_output = bbox_output  # class AutoregressiveBBoxOutput
    ...
    def _extract_properties_from_target(sample_params):
        class_labels = sample_params["ref_class_labels_tr"].float()
        translations = sample_params["ref_translations_tr"].float()
        sizes = sample_params["ref_sizes_tr"].float()
        angles = sample_params["ref_angles_tr"].float()
